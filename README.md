...
Output: `Week 6 _ Deliverable _ Sold Residential Enriched.csv` (455,449 × 62) and `Week 6 _ Deliverable _ Listing Residential Enriched.csv` (504,162 × 60) — the datasets every later week builds on — plus five small `Week 6 _ Segment _ <Dimension>.csv` files, one per summary table (each is exactly the top-10 table the script prints, saved for easy review in Excel).
